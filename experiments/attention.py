...
class AffineAttentionLayer(sparse.SparseLayer):
    """
    Version of the attention layer performs an affine transformation on the bounding box bounding the whole image.
