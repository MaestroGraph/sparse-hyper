...
class HyperLayer(nn.Module):
    ...
    def __init__(self, in_size, out_size, in_indices, additional=0, bias_type=Bias.DENSE, sparse_input=False, subsample=None):
        ...
        :param in_rank:
        :param out_indices: This should be a tensor (not a variable). Each row contains the index of a node in the
        output layer for which the hyperlayer will learn an input index.
        :param additional:
        :param bias_type:
        :param sparse_input:
        :param subsample:
