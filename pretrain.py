...
def pretrain(layers, shapes, pivots, loader, epochs=50, plot=False, k_out=256, out_additional=128, out_has_bias=True, learn_rate=0.005, use_cuda=False, has_channels=True):
